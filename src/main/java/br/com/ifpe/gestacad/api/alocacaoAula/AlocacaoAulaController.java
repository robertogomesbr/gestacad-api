...
@CrossOrigin
@Tag(name = "API Alocação de Aula", description = "API responsável pelos serviços de alocação de aulas e horários no sistema")
public class AlocacaoAulaController {
        ...
        @Operation(summary = "Serviço responsável pela criação de uma alocação de aula.", description = "Endpoint responsável por cadastrar uma nova alocação de aula associando turma, disciplina, sala e professor.")
        @PostMapping
        public ResponseEntity<AlocacaoAula> save(@RequestBody @Valid AlocacaoAulaRequest alocacaoAulaRequest,
        ...
        @Operation(summary = "Serviço responsável por listar todas as alocações de aula.", description = "Endpoint responsável por retornar todas as alocações de aula cadastradas.")
        @GetMapping
        ...
        @Operation(summary = "Serviço responsável por buscar uma alocação de aula pelo ID.", description = "Endpoint responsável por retornar uma alocação de aula específica a partir do seu ID.")
        @GetMapping("/{id}")
        ...
        @Operation(summary = "Serviço responsável por atualizar uma alocação de aula.", description = "Endpoint responsável por atualizar uma alocação de aula existente a partir do seu ID.")
        @PutMapping("/{id}")
        ...
        @Operation(summary = "Serviço responsável por remover uma alocação de aula.", description = "Endpoint responsável por excluir uma alocação de aula a partir do seu ID.")
        @DeleteMapping("/{id}")
        ...
        @Operation(summary = "Serviço responsável por adicionar um horário a uma alocação de aula.", description = "Endpoint responsável por cadastrar um novo horário vinculado a uma alocação de aula.")
        ...
        @Operation(summary = "Serviço responsável por atualizar um horário.", description = "Endpoint responsável por atualizar os dados de um horário existente.")
        ...
        @Operation(summary = "Serviço responsável por remover um horário.", description = "Endpoint responsável por excluir um horário associado a uma alocação de aula.")
