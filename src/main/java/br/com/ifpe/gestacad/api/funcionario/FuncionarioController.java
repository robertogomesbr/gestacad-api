...
@Tag(
        ...
        description = "API responsável pelos serviços de funcionários no sistema"
)
public class FuncionarioController {
    ...
    @Operation(
            summary = "Serviço responsável pela criação de um funcionário no sistema.",
            description = "Endpoint responsável por cadastrar um novo funcionário no sistema."
    )
    @PostMapping
    ...
    @Operation(
            summary = "Serviço responsável por listar todos os funcionários do sistema.",
            description = "Endpoint responsável por retornar a lista de todos os funcionários cadastrados."
    )
    @GetMapping
    ...
    @Operation(
            summary = "Serviço responsável por buscar um funcionário pelo ID.",
            description = "Endpoint responsável por retornar os dados de um funcionário específico a partir do seu ID."
    )
    @GetMapping("/{id}")
    ...
    @Operation(
            summary = "Serviço responsável por atualizar um funcionário pelo ID.",
            description = "Endpoint responsável por atualizar os dados de um funcionário existente a partir do seu ID."
    )
    @PutMapping("/{id}")
    ...
    @Operation(
            summary = "Serviço responsável por remover um funcionário pelo ID.",
            description = "Endpoint responsável por excluir um funcionário do sistema a partir do seu ID."
    )
    @DeleteMapping("/{id}")
